...
struct NoxContextCapabilityProfile: Equatable, Sendable {
    let appOnly: Bool
    ...
    static func from(_ capabilities: NoxCapabilityState) -> NoxContextCapabilityProfile {
...
enum NoxContextAcquisitionLevel: String, Codable, Sendable, CaseIterable {
    case appOnly
    case windowAware
