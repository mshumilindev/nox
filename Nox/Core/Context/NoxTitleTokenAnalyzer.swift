...
enum NoxTitleTokenAnalyzer {
    static func primarySegment(from title: String?) -> String? {
    ...
    static func secondarySegment(from title: String?) -> String? {
        guard let title, !title.isEmpty else { return nil }
        let separators = [" — ", " – ", " - ", " | ", " · "]
        for sep in separators {
            if let range = title.range(of: sep) {
    ...
    static func indicatesPassiveMedia(title: String?) -> Bool {
        hasMediaShapeEvidence(title: title) || hasPassiveContentShapeEvidence(title: title)
    }

    static func hasMediaShapeEvidence(title: String?) -> Bool {
    ...
    static func hasDocumentShapeEvidence(title: String?) -> Bool {
        guard let title else { return false }
    ...
    static func hasProjectShapeEvidence(title: String?) -> Bool {
        guard let title else { return false }
    ...
    static func hasCommunicationShapeEvidence(title: String?) -> Bool {
        guard let title else { return false }
    ...
    static func hasTransferShapeEvidence(title: String?) -> Bool {
        guard let title else { return false }
    ...
    static func looksLikeBrowserTabTitle(title: String?) -> Bool {
    ...
    static func hasPassiveContentShapeEvidence(title: String?) -> Bool {
        guard let title else { return false }
        let lower = title.lowercased()
        let markers = [
