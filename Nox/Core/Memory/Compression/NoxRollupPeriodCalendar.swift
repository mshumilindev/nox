...
enum NoxRollupPeriodCalendar {

    static func hourRange(containing date: Date, calendar: Calendar = .current) -> (start: Date, end: Date) {
    ...
    static func weekRange(containing date: Date, calendar: Calendar = .current) -> (start: Date, end: Date) {
        var cal = calendar
        cal.firstWeekday = 2
    ...
    static func quarterRange(containing date: Date, calendar: Calendar = .current) -> (start: Date, end: Date) {
    ...
    static func yearRange(containing date: Date, calendar: Calendar = .current) -> (start: Date, end: Date) {
    ...
    static func eraRange(start: Date, end: Date) -> (start: Date, end: Date) {
        (start, end)
    }
