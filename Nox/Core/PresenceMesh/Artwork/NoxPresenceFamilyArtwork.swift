...
nonisolated enum NoxPresenceFamilyArtwork {
    static func imageKey(for kind: NoxPresenceDeviceKind) -> String? {
        switch kind {
    ...
    static func defaultColor(for deviceKey: String) -> String {
