...
nonisolated enum DeviceArtworkFormat: String, Sendable {
    case png
}

nonisolated enum DeviceArtworkURLBuilder {
    ...
    static func imageURLs(deviceKey: String, colorKey: String, darkMode: Bool = true) -> [URL] {
