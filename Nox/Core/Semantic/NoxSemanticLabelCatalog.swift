...
nonisolated enum NoxSemanticLabelCatalog {
    ...
    static func memorySubtitle(appNames: [String]) -> String {
    ...
    static func semanticPulseTitle(from inference: NoxSemanticInference) -> String? {
    ...
    static func normalizePulseTitle(_ text: String) -> String {
    ...
    static func liveSignalPhrase(from inference: NoxSemanticInference) -> String? {
        semanticPulseTitle(from: inference)
    }

    static func continuityResumedPhrase(from inference: NoxSemanticInference) -> String? {
        guard let base = semanticPulseTitle(from: inference) else { return nil }
        return "\(base) resumed"
    }

    static func presenceHint(from inference: NoxSemanticInference) -> String? {
        semanticPulseTitle(from: inference)
    }

    static func focusBlockTitle(kind: NoxFocusBlockKind) -> String {
        switch kind {
