...
struct NoxAIWorkflowAssessment: Equatable, Sendable {
    let kind: NoxAIWorkflowKind
    let confidence: Double
    let phrase: String
    let reasons: [NoxSemanticReason]
}

struct NoxAIWorkflowClassifier {
    ...
    func assess(context: NoxSemanticContext) -> NoxAIWorkflowAssessment? {
