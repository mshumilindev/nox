...
enum NoxPhilosophy {
    ...
    static let phases: [Phase] = [.perform, .rest, .live, .am]

    static let inline = "I perform. I rest. I live. I am."

    static let localNote = "Everything stays on this Mac."
    ...
    static func emphasis(for presence: NoxPresenceState) -> Emphasis {
        switch presence {
    ...
    static func lineOpacity(for phase: Phase, emphasis: Emphasis) -> Double {
        let soft = 0.38
        let mid = 0.48
        let lift = 0.56
