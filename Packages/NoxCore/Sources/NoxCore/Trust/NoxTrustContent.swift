...
public struct NoxTrustSection: Identifiable, Equatable, Sendable {
    public let id: String
    public let title: String
    public let lines: [String]
}

public enum NoxTrustContent {

    public static let localBadge = "Runs locally on this Mac"

    public static let sections: [NoxTrustSection] = [
        NoxTrustSection(
            id: "stored",
