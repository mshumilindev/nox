...
nonisolated public enum NoxPresenceCurator {
    ...
    public static func isPresentableNoxEnvironment(_ node: NoxDiscoveredNode) -> Bool {
    ...
    public static func isPresentableApplePresence(_ node: NoxDiscoveredNode) -> Bool {
        guard node.state == .unavailable else { return false }
        guard node.deviceId.hasPrefix("apple-") else { return false }
    ...
    public static func displayEnvironmentName(_ raw: String) -> String? {
    ...
    public static func sanitizedHostName() -> String? {
        let raw = Host.current().localizedName ?? ""
        return displayEnvironmentName(raw)
    }

    public static func resolvedDeviceKind(for environmentName: String) -> NoxPresenceDeviceKind? {
        NoxPresenceDeviceKind.confidentlyInfer(from: environmentName)
    }

    public static func resolvedDeviceKind(for node: NoxDiscoveredNode) -> NoxPresenceDeviceKind? {
    ...
    public static func appleDisplayName(
        rawName: String,
        model: String,
        hostName: String?,
        serviceType: String
