...
@MainActor
public final class NoxPresenceStabilizer {
    public init() {}
    ...
    public func resolve(proposed: NoxPresenceState, at date: Date = Date()) -> NoxPresenceState {
    ...
    public func reset(to presence: NoxPresenceState) {
