...
nonisolated public enum NoxPresenceDeviceKind: String, Sendable {
    case macBookPro
    case macBookAir
    case iMac
    case macStudio
    ...
    public static func confidentlyInfer(from deviceName: String) -> NoxPresenceDeviceKind? {
...
public enum NoxPresenceCardTone: Sendable {
    case nearby
    case unavailable
    case awaitingTrust
    case trusted
