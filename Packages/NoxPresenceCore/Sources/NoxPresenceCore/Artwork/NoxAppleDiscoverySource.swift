...
public nonisolated enum NoxAppleDiscoverySource: String, Sendable, Codable, Equatable {
    case deviceInfo
    case mobileSync
    case companionLink
    case homeKit
    ...
    public var trustsHardwareFields: Bool {
        switch self {
    ...
    public func merged(with other: NoxAppleDiscoverySource?) -> NoxAppleDiscoverySource {
