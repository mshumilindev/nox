...
public nonisolated struct NoxMeshProfile: Equatable, Sendable, Codable {
    public let name: String

    public static let `default` = NoxMeshProfile(name: "default")

    public var isDefault: Bool { name == "default" }
...
nonisolated public enum NoxMeshRuntime {
    public static let profile: NoxMeshProfile = NoxMeshProfile.resolve()
