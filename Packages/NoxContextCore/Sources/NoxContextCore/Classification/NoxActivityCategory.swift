...
nonisolated public enum NoxActivityCategory: String, Codable, CaseIterable, Sendable {
    case productivity
    case development
    case research
    case communication
    ...
    public var analysisCategory: NoxAnalysisCategory {
        switch self {
    ...
    public var excludedFromAnalysis: Bool {
        !analysisCategory.participatesInBehavioralModel
    }

    public var isWorkLike: Bool {
        switch self {
