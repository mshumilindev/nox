...
public struct NoxContextAdapterRegistry: Sendable {
    private let adapters: [any NoxContextAdapter]

    public init(adapters: [any NoxContextAdapter] = NoxContextAdapterRegistry.defaultAdapters) {
    ...
    public static let defaultAdapters: [any NoxContextAdapter] = [
    ...
    public func collectEvidence(input: NoxContextAdapterInput) -> [NoxContextAdapterEvidence] {
