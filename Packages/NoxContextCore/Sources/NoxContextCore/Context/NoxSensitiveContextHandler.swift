...
nonisolated public enum NoxSensitiveContextHandler {
  ...
  public static func sanitizedTitle(
    _ title: String?,
  ...
  public static func genericMemoryTitle(sensitivity: NoxSensitivityLevel) -> String {
    switch sensitivity {
