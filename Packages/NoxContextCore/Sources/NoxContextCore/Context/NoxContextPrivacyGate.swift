...
public enum NoxContextPrivacyGate {
    public static func persistableSnapshot(from evidence: NoxContextEvidence) -> NoxPersistableContextSnapshot {
    ...
    public static func redactContentIdentity(_ identity: NoxContentIdentityEvidence, sensitivity: NoxSensitivityLevel) -> NoxContentIdentityEvidence {
...
public struct NoxPersistableContextSnapshot: Codable, Equatable, Sendable {
