...
public enum NoxDeterministicRollupEngine {

    public static func buildDailyFacts(
    ...
    public static func aggregateFacts(
    ...
    public static func buildNarrative(facts: NoxRollupFacts, level: NoxMemoryCompressionLevel) -> String {
