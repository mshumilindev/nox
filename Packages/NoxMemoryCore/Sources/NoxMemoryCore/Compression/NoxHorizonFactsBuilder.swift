...
public enum NoxHorizonFactsBuilder {

    public static func buildHourly(
    ...
    public static func enrich(_ facts: NoxRollupFacts, level: NoxMemoryCompressionLevel, children: [NoxRollupFacts]) -> NoxRollupFacts {
        var enriched = facts
        switch level {
        case .weekly:
