...
public enum NoxEraDetector {

    public struct EraCandidate: Equatable, Sendable {
    ...
    public static func deriveEraFacts(from yearlyOrMonthly: [NoxRollupFacts]) -> (eraLabel: String?, eraThemes: [String]) {
    ...
    public static func detectEraCandidates(
