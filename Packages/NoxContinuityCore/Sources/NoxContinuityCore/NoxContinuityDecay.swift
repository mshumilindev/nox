...
nonisolated public enum NoxContinuityDecay {
    ...
    public static func apply(to thread: NoxContinuityThread, at date: Date = Date()) -> NoxContinuityThread {
        var updated = thread
    ...
    public static func canResurface(_ thread: NoxContinuityThread, at date: Date = Date()) -> Bool {
