...
nonisolated public struct NoxContinuitySignature: Equatable, Sendable, Codable {
    public let ecosystemKey: String
    public let semanticType: NoxContinuitySemanticType
    public let appTokens: [String]
    public let semanticState: NoxSemanticState
    public let fusionLabel: NoxFusionLabel
    public let interactionProfile: String
    ...
    public init(
        ...
        self.ecosystemKey = ecosystemKey
...
nonisolated public enum NoxContinuitySemanticTypeResolver {
