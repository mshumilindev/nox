...
nonisolated public enum NoxContinuityResurfacingPresenter {

    public static func resurfacing(
    ...
    public static func threadDisplayTitle(_ thread: NoxContinuityThread) -> String {
    ...
    public static func threadDetailLine(_ thread: NoxContinuityThread) -> String {
        if thread.sensitivityLevel != .normal {
