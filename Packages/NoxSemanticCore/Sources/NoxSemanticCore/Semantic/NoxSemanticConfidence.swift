...
public enum NoxSemanticConfidence {
    public static let surfaceThreshold = 0.45
    public static let liveSignalThreshold = 0.62
    public static let memorySpanThreshold = 0.38
    public static let transientThreshold = 0.32

    /// Internal analytics only — not shown in product UI.
    public static func qualifier(for confidence: Double) -> String {
        switch confidence {
