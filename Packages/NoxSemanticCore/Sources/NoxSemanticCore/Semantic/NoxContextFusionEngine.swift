...
public struct NoxContextFusionResult: Equatable, Sendable {
    public let label: NoxFusionLabel
    public let confidence: Double
    public let phrase: String
    public let sensitivityLevel: NoxSensitivityLevel
    public let supportingSignals: [NoxSemanticReason]
}

public struct NoxContextFusionEngine {
    public init() {}

    public func fuse(context: NoxSemanticContext, browser: NoxBrowserContext) -> NoxContextFusionResult {
